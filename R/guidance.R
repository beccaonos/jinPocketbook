...
#'
#' This function builds the Justice in Numbers Pocketbook Guidance Page.
#'
#' @param doc A Word document object
#' @return The doc object with guidance added
#' @export
...
guidance <- function(doc) {
  ...
  officer::body_add_fpar(doc,
                         officer::fpar(
                            officer::ftext(intro1,
